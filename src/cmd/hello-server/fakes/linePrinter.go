...
func (fake *PrintLn) Println(arg1 ...interface{}) {
...
func (fake *PrintLn) PrintlnCallCount() int {
	fake.printlnMutex.RLock()
	defer fake.printlnMutex.RUnlock()
	return len(fake.printlnArgsForCall)
}

func (fake *PrintLn) PrintlnCalls(stub func(...interface{})) {
	fake.printlnMutex.Lock()
	defer fake.printlnMutex.Unlock()
	fake.PrintlnStub = stub
}

func (fake *PrintLn) PrintlnArgsForCall(i int) []interface{} {
	fake.printlnMutex.RLock()
	defer fake.printlnMutex.RUnlock()
...
func (fake *PrintLn) Invocations() map[string][][]interface{} {
...
func (fake *PrintLn) recordInvocation(key string, args []interface{}) {
